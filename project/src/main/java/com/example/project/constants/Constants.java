...
public class Constants {
    ...
    public static final String ERROR_ADDRESS_MAX_LENGTH = "error.address.max.length";
    public static final String ERROR_PHONE_MAX_LENGTH = "error.phone.max.length";
    ...
    public static final String USER_DELETE_FAIL = "account.delete.fail";
    public static final String USER_REGISTER_SUCCESS = "account.register.success";
    public static final String USER_REGISTER_FAILED = "account.register.failed";
